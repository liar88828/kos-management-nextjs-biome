...
export function ProfilePage() {
    ...
    return (
        <div className="space-y-6">
            {/* Header with Avatar */ }
            <Card className="border-primary p-6 shadow-md">
                <div className="flex items-center gap-6">
                    <Avatar className="h-24 w-24 ring-2 ring-primary">
                        <AvatarImage
                            alt={ tenant.nama }
                            src={ `https://api.dicebear.com/7.x/initials/svg?seed=${ tenant.nama }` }
                        />
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground text-sm">
                            Member sejak { tenant.masuk || "2022" }
                        </p>
                        <Badge
                            className={ `mt-2 ${
            ...
            <Card className="shadow-sm">
                ...
                <CardContent className="grid grid-cols-1 gap-x-8 gap-y-4 sm:grid-cols-2">
                    ...
                    <Info
                        label="Jenis Kelamin"
                        value={ tenant.jenisKelamin ?? "-" }
                    />
                    <Info
                        label="Tanggal Lahir"
                        value={ tenant.tanggalLahir ?? "-" }
                    />
                    <Info label="Nomor KTP" value={ tenant.ktp ?? "-" }/>
                    <Info
                        label="Kontak Darurat"
                        value={ tenant.kontakDarurat ?? "-" }
                    />
                    <Info
                        label="Deposit"
                        value={ `Rp ${ tenant.deposit?.toLocaleString() ?? "0" }` }
                    />
                    <Info
                        label="Catatan"
                        value={ tenant.catatan ?? "Tidak ada catatan" }
                    />
                </CardContent>
            </Card>
            ...
            <Card className="p-6 shadow-sm">
                ...
                <CardContent className="space-y-3">
                    <p className="text-muted-foreground text-sm">
                        Kelola keamanan akun dan sesi Anda
                    </p>
