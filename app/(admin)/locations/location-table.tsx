...
import { LocationDialogForm } from "@/app/(admin)/locations/location-form-dialog";
                        ...
                        { locations.map((loc) => (
                            <TableRow key={ loc.id + loc.key }>
                                <TableCell className="font-medium">
                                    ...
                                    <p className={ "text-primary/70" }>{ loc.address }</p>
                                    <p>{ loc.city }</p>
                                </TableCell>
                                <TableCell>
                                    <p>
                                ...
                                <TableCell>
                                    ...
                                    <p>
                                        Bulan:
                                        { formatPrice(loc.room?.[0].hargaBulanan ?? 0) }
                                    </p>
                                    <p>
                                        Tahun:
                                        { formatPrice(loc.room?.[0].hargaTahunan ?? 0) }
                                    </p>
                                </TableCell>
