...
export function NotFoundPage({
    ...
    return (
        <div
            className="flex min-h-[72vh] items-center justify-center bg-gradient-to-b from-gray-50 to-white px-6 py-12">
            <motion.div
            ...
            >
                <Card className="overflow-hidden rounded-2xl shadow-lg">
                    <div className="grid grid-cols-1 md:grid-cols-2">
                        ...
                        <div
                            className="flex items-center justify-center bg-gradient-to-br from-indigo-600 via-violet-600 to-pink-500 p-8">
                            <motion.div
